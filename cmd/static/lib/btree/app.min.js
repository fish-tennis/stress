...
!function(){"use strict";var t=function(t){this.Container_constructor(),this._id=b3.createUUID(),this._editor=t,this._selectedTree=null,this._clipboard=null,this._nodes={},this.trees=null,this.nodes=null,this.history=null,this._initialize()},e=createjs.extend(t,createjs.Container);e._initialize=function(){this.trees=new b3e.project.TreeManager(this._editor,this),this.nodes=new b3e.project.NodeManager(this._editor,this),this.history=new b3e.project.HistoryManager(this._editor,this),this.nodes.add(b3e.Root,!0),this.nodes.add(b3.Sequence,!0),this.nodes.add(b3.Priority,!0),this.nodes.add(b3.MemSequence,!0),this.nodes.add(b3.MemPriority,!0),this._applySettings(this._editor._settings),this.history.clear(),this._editor.clearDirty()},e._applySettings=function(t){this.trees._applySettings(t),this.nodes._applySettings(t),this.history._applySettings(t)},b3e.project.Project=createjs.promote(t,"Container")}();
...
b3e.editor.SelectionSystem=function(e){"use strict";var t=!1,i=!1,o=!1,s=!1,n=0,c=0;this.update=function(e){},this.onMouseDown=function(l){var a=e.project.get();if(a){var r=a.trees.getSelected();if(r&&1===l.nativeEvent.which){i=l.nativeEvent.ctrlKey,o=l.nativeEvent.shiftKey,s=l.nativeEvent.altKey;var v=r.view.getLocalPoint(),g=v.x,h=v.y,u=r.blocks.getUnderPoint(g,h);u&&u._isSelected&&i?s?r.selection.deselectSubtree(u):r.selection.deselect(u):u&&!u._isSelected&&u._hitBody(g,h)?(i||r.selection.deselectAll(),s?r.selection.selectSubtree(u):r.selection.select(u)):u&&u._hitBody(g,h)?s&&r.selection.selectSubtree(u):u||(t=!0,n=g,c=h,i||r.selection.deselectAll())}}},this.onMouseMove=function(i){if(t){var o=e.project.get();if(o){var s=o.trees.getSelected();if(s){var l=s.view.getLocalPoint(),a=l.x,r=l.y;s._selectionBox.visible=!0,s._selectionBox._redraw(n,c,a,r)}}}},this.onMouseUp=function(i){if(1===i.nativeEvent.which&&t){var o=e.project.get();if(o){var s=o.trees.getSelected();if(s){var l=s.view.getLocalPoint(),a=l.x,r=l.y,v=Math.min(n,a),g=Math.min(c,r),h=Math.max(n,a),u=Math.max(c,r);s.blocks.each(function(e){e._isContainedIn(v,g,h,u)&&s.selection.select(e)}),s._selectionBox.visible=!1,t=!1}}}},this.onDblclick=function(t){var i=e.project.get();if(i){var o=i.trees.getSelected();if(o){var s=o.view.getLocalPoint(),n=s.x,c=s.y,l=o.blocks.getUnderPoint(n,c);"tree"===l.category&&i.trees.select(l.name)}}},e._game.stage.on("stagemousedown",this.onMouseDown,this),e._game.stage.on("stagemousemove",this.onMouseMove,this),e._game.stage.on("stagemouseup",this.onMouseUp,this),e._game.stage.on("dblclick",this.onDblclick,this)};
...
!function(){"use strict";function n(n,t,o,e,r,i){function u(){}function c(t){return n.$$phase?g():n.$apply(function(){g()}),!1}function s(t){return n.$$phase?y():n.$apply(function(){y()}),!1}function a(){Mousetrap.bind("ctrl+q",c),Mousetrap.bind("ctrl+s",s),Mousetrap.bind("ctrl+z",C),Mousetrap.bind("ctrl+shift+z",P),Mousetrap.bind("ctrl+c",z),Mousetrap.bind("ctrl+v",x),Mousetrap.bind("ctrl+x",I),Mousetrap.bind("ctrl+d",w),Mousetrap.bind("del",S),Mousetrap.bind("a",R),Mousetrap.bind("ctrl+a",D),Mousetrap.bind("ctrl+shift+a",N),Mousetrap.bind("ctrl+i",q)}function d(){Mousetrap.unbind("ctrl+q",c),Mousetrap.unbind("ctrl+s",s),Mousetrap.unbind("ctrl+z",C),Mousetrap.unbind("ctrl+shift+z",P),Mousetrap.unbind("ctrl+c",z),Mousetrap.unbind("ctrl+v",x),Mousetrap.unbind("ctrl+x",I),Mousetrap.unbind("ctrl+d",w),Mousetrap.unbind("del",S),Mousetrap.unbind("a",R),Mousetrap.unbind("ctrl+a",D),Mousetrap.unbind("ctrl+shift+a",N),Mousetrap.unbind("ctrl+i",q)}function p(){return t.editor.project.get()}function l(){var n=t.editor.project.get();return n.trees.getSelected()}function f(){return o.go("editor.export",{type:"project",format:"json"}),!1}function v(){return o.go("editor.export",{type:"tree",format:"json"}),!1}function b(){return o.go("editor.export",{type:"nodes",format:"json"}),!1}function M(){return o.go("editor.import",{type:"project",format:"json"}),!1}function m(){return o.go("editor.import",{type:"tree",format:"json"}),!1}function j(){return o.go("editor.import",{type:"nodes",format:"json"}),!1}function g(){function n(){r.closeProject(),o.go("dash.projects")}return t.editor.isDirty()?e.confirm("Leave without saving?","If you proceed you will lose all unsaved modifications.",null).then(n):n(),!1}function h(){y(),o.go("dash.projects")}function y(){return r.saveProject().then(function(){i.success("Project saved","The project has been saved")},function(){i.error("Error","Project couldn't be saved")}),!1}function $(){var n=p();return n.trees.add(),!1}function C(){var n=p();return n.history.undo(),!1}function P(){var n=p();return n.history.redo(),!1}function z(){var n=l();return n.edit.copy(),!1}function I(){var n=l();return n.edit.cut(),!1}function x(){var n=l();return n.edit.paste(),!1}function w(){var n=l();return n.edit.duplicate(),!1}function S(){var n=l();return n.edit.remove(),!1}function A(){var n=l();return n.edit.removeConnections(),!1}function J(){var n=l();return n.edit.removeInConnections(),!1}function O(){var n=l();return n.edit.removeOutConnections(),!1}function R(){var n=l();return n.organize.organize(),!1}function T(){var n=l();return n.view.zoomIn(),!1}function E(){var n=l();return n.view.zoomOut(),!1}function D(){var n=l();return n.selection.selectAll(),!1}function N(){var n=l();return n.selection.deselectAll(),!1}function q(){var n=l();return n.selection.invertSelection(),!1}var Z=this;Z.onNewTree=$,Z.onCloseProject=g,Z.onBackToProject=h,Z.onSaveProject=y,Z.onExportProjectJson=f,Z.onExportTreeJson=v,Z.onExportNodesJson=b,Z.onImportProjectJson=M,Z.onImportTreeJson=m,Z.onImportNodesJson=j,Z.onUndo=C,Z.onRedo=P,Z.onCopy=z,Z.onCut=I,Z.onPaste=x,Z.onDuplicate=w,Z.onRemove=S,Z.onRemoveAllConns=A,Z.onRemoveInConns=J,Z.onRemoveOutConns=O,Z.onAutoOrganize=R,Z.onZoomIn=T,Z.onZoomOut=E,Z.onSelectAll=D,Z.onDeselectAll=N,Z.onInvertSelection=q,a(),u(),n.$on("$destroy",d)}angular.module("app").controller("MenubarController",n),n.$inject=["$scope","$window","$state","dialogService","projectModel","notificationService"]}();
!function(){"use strict";function e(e,t,o,r){function n(){m.trees=[],m.nodes={composite:[],decorator:[],action:[],condition:[]};var e=t.editor.project.get(),o=e.trees.getSelected();e.trees.each(function(e){var t=e.blocks.getRoot();v(t)||m.trees.push({id:e._id,name:t.title||"A behavior tree",active:e===o,index:m.trees.length})}),m.trees.sort(function(e,t){return e.name.toLowerCase().charCodeAt(0)-t.name.toLowerCase().charCodeAt(0)}),e.nodes.each(function(e){if("tree"!==e.category&&!v(e)){var t=m.nodes[e.category];t&&t.push({name:e.name,title:a(e),isDefault:e.isDefault,index:t.length})}});for(var r in m.nodes)m.nodes[r].sort(function(e,t){return 1==e.isDefault&&1==t.isDefault?e.index-t.index:e.isDefault?-1:t.isDefault?1:e.title.toLowerCase().charCodeAt(0)-t.title.toLowerCase().charCodeAt(0)})}function i(t){setTimeout(function(){e.$apply(function(){n()})},0)}function d(){t.editor.on("treenodechanged",i),t.editor.on("noderemoved",i),t.editor.on("nodeadded",i),t.editor.on("treeadded",i),t.editor.on("treeselected",i),t.editor.on("treeremoved",i),t.editor.on("treeimported",i)}function c(){t.editor.off("treenodechanged",i),t.editor.off("noderemoved",i),t.editor.off("nodeadded",i),t.editor.off("treeadded",i),t.editor.off("treeselected",i),t.editor.off("treeremoved",i),t.editor.off("treeimported",i)}function a(e){var t=e.title||e.name;return t=t.replace(/(<\w+>)/g,function(e,t){return"@"})}function s(){var e=t.editor.project.get();e.trees.add()}function f(e){var o=t.editor.project.get();o.trees.select(e)}function l(e){o.confirm("Remove tree?","Are you sure you want to remove this tree?\n\nNote: all blocks using this tree will be removed.").then(function(){var o=t.editor.project.get();o.trees.remove(e),r.success("Tree removed","The tree has been removed from this project.")})}function u(){n()}function v(e){if(null!==m.filter||void 0!==m.filter||0==m.filter.replace(/(^s*)|(s*$)/g,"").length){var t=new RegExp(m.filter,"i");return-1==a(e).search(t)}return!0}var m=this;m.nodes=null,m.newTree=s,m.select=f,m.remove=l,m.search=u,m.filter="",d(),n(),e.$on("$destroy",c)}angular.module("app").controller("NodespanelController",e),e.$inject=["$scope","$window","dialogService","notificationService"]}();
...
!function(){"use strict";function t(t,e,n,r,o,c,i){function a(){r.save(g,P)}function u(t){if(t){for(var e=P.length-1;e>=0;e--)P[e].path===t.path?P.splice(e,1):P[e].isOpen=!1;var n={name:t.name,description:t.description,path:t.path,isOpen:!0};P.splice(0,0,n)}else for(var r=0;r<P.length;r++)P[r].isOpen=!1;a()}function s(t){S=t,u(t),e.$broadcast("dash-projectchanged")}function f(){return t(function(t,e){if(!P){var n;try{n=r.load(g)}catch(o){}n||(n=[]),P=n}t(P)})}function p(e,n){return t(function(t,r){var o={name:n,description:"",data:[],path:e};i.newProject(),o.data=i.exportProject(),d(o).then(function(){s(o),t()})})}function l(){return S}function d(e){return e=e||S,e.data=i.exportProject(),t(function(t,c){n.editor.clearDirty(),o.isDesktop?r.save(e.path,JSON3.stringify(e,null,2)):r.save(e.path,e),u(e),t()})}function h(e){return t(function(t,e){c.getAgent().then(function(e){var n=e.Gets();c.setData(e,n),i.openProject(n.data),s(n),t()})})}function j(){return t(function(t,e){n.editor.clearDirty(),i.closeProject(),s(null),t()})}function v(e){return t(function(t,n){for(var r=0;r<P.length;r++)if(P[r].path===e){P.splice(r,1);break}a(),t()})}var g=o.join(o.getDataPath(),"recents.json"),P=null,S=null,m={getRecentProjects:f,newProject:p,getProject:l,saveProject:d,openProject:h,closeProject:j,removeProject:v};return m}angular.module("app").factory("projectModel",t),t.$inject=["$q","$rootScope","$window","storageService","systemService","fileStorageService","editorService"]}();
...
!function(){"use strict";function e(e){function n(n,o,l){n.keytable.heading=l.heading,n.keytable._onChange=e(l.ngChange);var r=l.ngModel;n.$watch(r,function(e){n.keytable.reset(e)})}var o={require:"^ngModel",restrict:"EA",replace:!0,bindToController:!0,controller:"KeyTableController",controllerAs:"keytable",templateUrl:"directives/keytable.html",link:n};return o}function n(e){function n(){if(a.model)for(var e in a.model)l(e,a.model[e],!1);else a.model={}}function o(e){a.rows=[],a.model=e,n()}function l(e,n,o){a.rows.push({key:e,value:JSON.stringify(n),fixed:o===!0})}function r(e){a.rows.splice(e,1)}function t(){for(var n in a.model)a.model.hasOwnProperty(n)&&delete a.model[n];for(var o=0;o<a.rows.length;o++){var l=a.rows[o];if(l.key){var r=l.value;try{r=JSON.parse(r)}catch(t){}a.model[l.key]=r,a._onChange&&a._onChange(e)}}}var a=this;a._onChange=null,a.model=e.keytable.model||e.model||null,a.rows=[],a.add=l,a.remove=r,a.change=t,a.reset=o,n()}angular.module("app").directive("b3KeyTable",e).controller("KeyTableController",n),e.$inject=["$parse"],n.$inject=["$scope"]}();
...
function fileStorageService(e){function t(e,t){a=t,u=e}function n(e,t){if(e===a.path)return void u.Sets(t);if("string"!=typeof t)try{t=JSON3.stringify(t)}catch(n){}}function r(e){return"treejson"===e?f.Gets():null}function o(e){}function i(){return new FileAgent("./conf/robot.b3","Btree")}var c=!0,f=new FileAgent("./conf/robot.b3","Btree"),a={path:""},u=null,l={ok:c,save:n,load:r,getAgent:i,setData:t,remove:o};return l}angular.module("app").factory("fileStorageService",fileStorageService),fileStorageService.$inject=["nodejsService"];
